...
namespace Infrastructure
{
    ...
    /// 类名：MethodInvokeUtil.cs
    /// 类属性：公共类（非静态）
    /// 类功能描述：
    /// 创建标识：yjq 2017/11/28 18:51:47
    /// </summary>
    public sealed class MethodInvokeUtil
    {
        private static ConcurrentDictionary<MethodInfo, IMethodInvoker> MethodCache = new ConcurrentDictionary<MethodInfo, IMethodInvoker>();

        public static IMethodInvoker GetInvoker(MethodInfo methodInfo)
        {
            return MethodCache.GetValue(methodInfo, () =>
             {
